...
async def list_modules() -> JSONResponse:
    return JSONResponse({
        "modules": [
            {"id": "localbuddy", "name": "LocalBuddy", "icon": "bot", "description": "LLM Chat"},
            {"id": "ragforge", "name": "RAGForge", "icon": "database", "description": "Document Q&A"},
            {"id": "watchtower", "name": "WatchTower", "icon": "activity", "description": "Performance Metrics"},
            {"id": "streamsync", "name": "StreamSync", "icon": "refresh", "description": "Live Folders"},
