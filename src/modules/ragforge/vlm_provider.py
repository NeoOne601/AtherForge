...
class SmolVLMProvider(VLMProvider):
    ...
    @property
    def id(self) -> str: return "smolvlm-256m"
    
    @property
    def name(self) -> str: return "SmolVLM 256M (Lite)"
    
    @property
    def required_ram_gb(self) -> float: return 0.8
    
    @property
    def tier(self) -> str: return "Lite"
...
class FlorenceProvider(VLMProvider):
    ...
    @property
    def id(self) -> str: return "florence2-base"
    
    @property
    def name(self) -> str: return "Florence-2 Base (Balanced)"
    
    @property
    def required_ram_gb(self) -> float: return 1.0
    
    @property
    def tier(self) -> str: return "Balanced"
    ...
    async def analyze_image(self, image_bytes: bytes, prompt: str) -> str:
        ...
        def _analyze():
            ...
            inputs = self.processor(text=task_prompt, images=image, return_tensors="pt").to(self.device, self.model.dtype)
    ...
    async def load_model(self):
        ...
        def _pull():
            ...
            try:
                ...
                logger.warning("Ollama pull failed for %s (is Ollama running?): %s", self._model_name, e)
